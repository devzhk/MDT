...
torchrun --nproc_per_node=8 image_train.py --image_size 256 --mask_ratio 0.30 --decode_layer 2 --model MDT_XL_2 --diffusion_steps 1000 --batch_size 32 --log_interval 1000